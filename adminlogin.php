...
<h2 ALIGN="CENTER"><b><u>PLACEMENT MANAGEMENT SYSTEM</u></b></h2>
<meta name="viewport" content="width=device-width, initial-scale=1">
<style>
...
<br>
   ...
   <a href="slogin.php"> <button type="button" class="btn btn-danger">Cancel</button>
</form>
...
$sql=mysqli_query($conn,"SELECT * from `adminlogin` where `username`='$username' and `password`='$password'");
